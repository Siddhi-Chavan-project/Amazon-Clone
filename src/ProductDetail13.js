...
const ProductDetail13 = () => {
    ...
    const product = {
        name: '',
        description: ' VIBHAVARI Elegant Rakhi/ Band (Rakhi Combo of 4) for Beloved Brother with Tilak Material ) for brother ,bhaiyya ,bro '
        ,
        price: 300,
    ...
    return (
        <div className="product-details">
            <img src="https://m.media-amazon.com/images/I/717WnMuwjiL._UY695_.jpg" alt="" />
            <h1>{product.name}</h1>
