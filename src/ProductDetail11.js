...
const ProductDetail11 = () => {
    ...
    const product = {
        name: '',
        description: ' Sukkhi Rakhi Stylish Kundan Rakhi Combo & Designer Gold Plated Premium Rakhi for Brother, Rakhi  '
        ,
        price: 100,
    ...
    return (
        <div className="product-details">
            <img src="https://m.media-amazon.com/images/I/91Bw8OYErxL._UY695_.jpg" alt="" />
            <h1>{product.name}</h1>
